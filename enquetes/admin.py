...
class CustomAdmin(admin.ModelAdmin):
    """Classe personalizada para agregar a funcionalidade de subir data via .csv"""
    ...
    def upload_csv(self, request):
        """Maneixa o carregamento de dados via um arquivo .csv no modelo 
        GET: Mostra um form com um unico campo pra carregar .csv  
        POST: Processa o form, verifica a extansão do arquivo
            tenta criar tantas instancias do modelo como linhas tenha o arquivo
            se alguma instancia falhar nenhuma será criada"""
        
        if request.method == "POST":
            # validando extensão do arquivo => .csv
            ...
            if form.is_valid(): 
                ...
                # dando mensagem de erro e redireccionado para url anterior
                    ...
                    messages.warning(request, "Não foi possivel processar sua solicitude, por favor verifique o formato de seu arquivo")
                 ...
                 # dando mensagem de sucesso e redirecionado para change list do respetivo modelo
                    ...
                    messages.success(request, "Seus dados foram carregados com sucesso")
        ...
        context = {
            'nome_do_modelo': self.model.__name__,
            'form': form
        }
